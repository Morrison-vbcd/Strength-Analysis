...
| 分頁 | 功能 |
|---|---|
| 📊 個股相對強弱 | 核心標的 vs 同質參考股，ZigZag 結構段熱力圖、現況排名、RS 線、型態訊號（⭐強/⚠️弱、含已確認/進行中狀態）、訊號歷史應驗率統計、復盤模式（含逐週/逐月步進器）、美股「🧲 同質參考股推薦」（46 板塊/340+ 檔研究對照表，一鍵帶入） |
...
peers.py             # 美股同質性 peers 推薦（反查 peers_us.json）
peers_us.json        # 同質性研究對照表（2026-07：46 板塊/340+ 檔，每季換版）
