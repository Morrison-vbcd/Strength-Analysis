...
| 分頁 | 功能 |
|---|---|
| 📊 個股相對強弱 | 核心標的 vs 同質參考股，ZigZag 結構段熱力圖、現況排名、RS 線、型態訊號（⭐強/⚠️弱）、復盤模式 |
| 🔄 板塊輪動 | RRG 相對輪動圖（快照/軌跡/動畫回放）、risk-on/off 判定、象限轉換訊號表、板塊 vs 大盤結構熱力圖 |
| 🔗 配對交易 | 共整合檢定（Engle-Granger + ADF）、β 對沖比、spread z-score、半衰期、進出場提示 |
